...
public class OCRPredictorNative {
    ...
    public OCRPredictorNative(Config config) {
        this.config = config;
        loadLibrary();
        Log.i("OCRPredictorNative", "OCRPredictorNative: " + config.detModelFilename + " " + config.recModelFilename + " " + config.clsModelFilename + " " + config.useOpencl + " " + config.cpuThreadNum + " " + config.cpuPower);
